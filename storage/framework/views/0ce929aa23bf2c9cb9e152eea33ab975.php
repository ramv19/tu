...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Tú Significado - Descubre el significado de tu nombre'); ?></title>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo e(route('name.search')); ?>" class="text-light text-decoration-none">Buscar Nombre</a></li>
                        <li><a href="<?php echo e(route('register')); ?>" class="text-light text-decoration-none">Registrarse</a></li>
                        <li><a href="<?php echo e(route('login')); ?>" class="text-light text-decoration-none">Iniciar Sesión</a></li>
                    </ul>
                </div>
                <div class="col-md-3">
...
</html><?php /**PATH C:\xampp\htdocs\tu\resources\views/layouts/app.blade.php ENDPATH**/ ?>